	...
	return (
		<>
			<div className="w-fit mx-auto text-center">
				<h2 className="text-xl sm:text-2xl md:text-4xl font-semibold uppercase">
					maintain movie continuity and track your favorites
				</h2>
			</div>
			<div className="flex flex-col w-fit gap-4 md:mx-auto py-4 items-center">
				...
				<CtaButton type="button" icon={null} text="go to search" action={handleButtonClick} />
			</div>
		</>
	);
}
